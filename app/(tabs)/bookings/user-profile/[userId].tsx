...
import { getUserProfile, getUserReviews } from '../../../../services/userService';
...
const UserPublicProfileScreenFromBookings = () => {
...
export default UserPublicProfileScreenFromBookings;
