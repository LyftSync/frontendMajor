...
import { View, Text, StyleSheet, ScrollView, Alert, TextInput as RNTextInput } from 'react-native'; // Renamed to avoid conflict
...
const AddReviewScreen = () => {
  ...
  const { rideId, revieweeId, reviewType, revieweeName } = useLocalSearchParams(); 
